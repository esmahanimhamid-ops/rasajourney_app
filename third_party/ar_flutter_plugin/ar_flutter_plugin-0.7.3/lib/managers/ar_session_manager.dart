...
class ARSessionManager {
  ...
  onInitialize({
    ...
    String? imageTrackingAssetPath,
    double? imageTrackingPhysicalWidthMeters,
    ...
    _channel.invokeMethod<void>('init', {
      ...
      'imageTrackingAssetPath': imageTrackingAssetPath,
      'imageTrackingPhysicalWidthMeters': imageTrackingPhysicalWidthMeters,
